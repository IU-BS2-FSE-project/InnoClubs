...
urlpatterns = [
    ...
    # <str:club_url> means that we can access any club using club_url
    # (we set club_url for each club in database)
    ...
    path('type/<str:club_url>/administration/<str:person_id>/Kick/', views.kick, name='kick'),
